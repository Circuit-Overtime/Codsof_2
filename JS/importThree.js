...
var scene, camera, fieldOfView, aspectRatio, nearPlane, farPlane, HEIGHT, WIDTH, renderer, container_three;
...
function createScene() {
	...
	container_three = document.getElementById('Three_container');
...
function init(event) {
	...
	document.getElementById("SecondRowFirstLayoutInnovate").addEventListener('mousemove', handleMouseMove, false);
    document.getElementById("SecondRowFirstLayoutInnovate").addEventListener('mouseout', handleMouseOut, false);
