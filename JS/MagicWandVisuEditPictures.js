...
containerPicture = document.getElementById("SecondRowFirstLayout");
...
containerPicture.onmousemove = e => {
    ...
    if((e.clientX >= PictureContainerLeft) && (e.clientX <= PictureContainerRight))
    {
        const PictureWandStyles = {
            ...
            top: px(mapRange(e.clientY, PictureContainerTop, PictureContainerBottom, 210,230 )),
...
containerPicture.onmouseleave = e => {
    ...
    document.getElementById("SecondRowFirstLayoutFirstImage").animate(Picture1Style, {duration : 400, fill : "forwards"});
    document.getElementById("SecondRowFirstLayoutSecondImage").animate(Picture2Style, {duration : 400, fill : "forwards"});
    document.getElementById("SecondRowFirstLayoutThidImage").animate(Picture3Style, {duration : 400, fill : "forwards"});
